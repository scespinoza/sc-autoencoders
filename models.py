...
class Encoder(layers.Layer):
    ...
    def __init__(self, original_dim=5491, latent_dim=10, name='Encoder'):
        ...
        self.logvar_dense = layers.Dense(latent_dim, activation='linear', kernel_initializer='he_normal')
...
class VaDE(tf.keras.Model):
    ...
    def vade_loss(self, inputs):
        ...
        p_c = self.pi_prior
        gamma = self.compute_gamma(z)
        log_p_x_z = 1.5 * self.original_dim * losses.binary_crossentropy(x, x_hat)
