...
class TrainerVaDE:
    ...
    def train_GMM(self):
        ...
        x = torch.cat([data for data in self.dataloader]).to(self.device) #all x samples.
    ...
    def test_VaDE(self, epoch):
        ...
        with torch.no_grad():
            ...
            print('Testing VaDE... Epoch: {}, Loss: {}, Acc: {}'.format(epoch, total_loss, 0))
    ...
    def compute_loss(self, x, x_hat, mu, log_var, z):
        ...
        log_p_x_given_z = F.mse_loss(x_hat, x.float(), reduction='sum')
    ...
    def compute_gamma(self, z, p_c):
        ...
        print(h)
        h += self.VaDE.log_var_prior; print(self.VaDE.log_var_prior)
        print(h)
